...
const ArticleMetaGhost = ({ data, settings, canonical, id }) => {
    ...
    const author = getAuthorProperties(
        ghostPost.frontmatter.author.frontmatter
    );
    ...
    const publisherLogo = config.siteIcon
        ? url.resolve(config.siteUrl, config.siteIcon)
        : null;
    const articleId = id;
        ...
        <>
            <Helmet>
                ...
                <meta
                    ...
                    content={ghostPost.frontmatter.published_at}
                />
                <meta
                    property="article:modified_time"
                    content={ghostPost.frontmatter.updated_at}
                />
                ...
                <script type="application/ld+json">{`
                    {
                        ...
                        "url": "${canonical}",
                        "datePublished": "${
                            ghostPost.frontmatter.published_at
                        }",
